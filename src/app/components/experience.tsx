...
const experienceList: ExperienceItem[] = [
    {
        ...
        bullets: [
            ...
            'Deliver client web platforms, including a social media-esque platform for chronic pain support, a video coaching product, and headless Shopify storefronts.',

...
const experienceList: ExperienceItem[] = [
    {
        ...
        bullets: [
            ...
            'Deliver client web platforms, including a video coaching product and headless Shopify storefronts, using AI coding assistants to speed up delivery and iterate faster with stakeholders.',
